...
import java.awt.*;
public class ReflectionInX extends JFrame implements ActionListener{
    JTextField tf1,tf2,tf3,tf4;
    JLabel l1,l2,l3,l4,signature;
    Graphics g;
    JButton jb;
    ReflectionInX(){
        this.setTitle("Reflection on X ");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        g.drawString("Before Reflection", x1-10, y2+20);
        g.drawLine(y1,x1,y2,x2);
        g.drawString("After Reflection", y1-10, x2+20);
    }
}
