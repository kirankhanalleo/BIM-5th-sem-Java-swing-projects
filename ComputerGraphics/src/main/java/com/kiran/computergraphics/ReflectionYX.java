...
public class ReflectionYX extends JFrame implements ActionListener {
    JTextField tf1,tf2,tf3,tf4,tf5,tf6;
    JLabel l1,l2,l3,l4,l5,l6,signature;
    JButton jb;
    Graphics g;
    public ReflectionYX(){
        this.setTitle("Reflection Through Line Y=X");
    ...
    g.drawLine(x2, y2, x3, y3);
    g.drawLine(x3, y3, x1, y1);
    g.drawString("After Reflection", 400, 620);
    }
