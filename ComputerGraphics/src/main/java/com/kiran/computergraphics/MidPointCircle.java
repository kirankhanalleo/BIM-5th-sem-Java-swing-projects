...
public class MidPointCircle extends JFrame implements ActionListener{
    JTextField tf1,tf2,tf3;
    JLabel l1,l2,l3,signature;
    JButton jb;
    Graphics g;
    public MidPointCircle(){
        this.setTitle("Mid-Point Circle Drawing Algorithm");
    ...
    @Override
        public void actionPerformed(ActionEvent ae){
            ...
            int yc=Integer.parseInt(tf3.getText()); 
            int X=0;
            int Y=r;
            int P=5/4-r;
            yc+=40;
